...
$(document).ready(function() {
	...
	$(document).ready(function() {
		...
		// Sidebar Slimscroll Initialization
		if ($sidebar.length > 0) {
			$sidebar.slimScroll({
				height: '100vh',  // Full height
				size: '6px',       // Scrollbar width
				position: 'right',
				color: '#ccc',     // Scrollbar color
				wheelStep: 10,
				touchScrollStep: 100
			});
		}
        ...
        menu.addEventListener("click", function (e) {
            ...
            document.querySelectorAll(".submenu").forEach((item) => {
                if (item !== parent) {
                    ...
                    let otherArrow = item.querySelector(".menu-arrow");
                    if (otherArrow) {
            ...
            // Prevent scrolling when opening submenu on mobile
            if (window.innerWidth <= 992) {
                sidebar.scrollTop = parent.offsetTop;
            }
        });
    });
});
